...
declare const relationshipPopulationPromise: ({ currentDepth, depth, fallbackLocale, field, locale, overrideAccess, req, showHiddenFields, siblingDoc, }: PromiseArgs) => Promise<void>;
