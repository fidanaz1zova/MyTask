...
prodPrice.style.width = "75px"
prodPrice.style.height = "35px"
prodPrice.style.border = "2px solid green"
prodPrice.innerText = elem.price
let basketbtn = document.createElement ("button")
basketbtn.className = "basketbtn"
basketbtn.style.width = "100px"
basketbtn.style.height = "40px"
basketbtn.style.border = "2px solid rgba(159, 4, 198, 0.582)"
basketbtn.style.borderRadius = "20px"
basketbtn.style.background = "rgba(159, 4, 198, 0.582)"
...
basketbtn.setAttribute ("data", elem.id);
...
page.append(card);
card.append(img, prodTitle, prodPrice, basketbtn, deletebtn) ;
basketbtn.addEventListener ("click", function () {
  console.log(...this.dataset, basket)
  basket.push (elem)
  basket.forEach (elem => {
    // let divbasket= document.createElement ("div")
    // divbasket.className = "divbasket"
    // divbasket.style.width = "500px"
    // divbasket.style.height = "100px"
    // divbasket.style.border = "5px solid black"
    // divbasket.style.borderRadius = "50px"
    ...
    minbtn.style.border = "1px solid black"
    minbtn.style.background = "white"
    minbtn.innerText = "-"
    let zero = document.createElement ("p");
    zero.innerText = elem.count
    zero.style.width = "30px"
    zero.style.height = "30px"
    zero.style.border = "1px solid black"
    ...
    maxbtn.style.border = "1px solid black"
    ...
    // basket.append (i, p, minbtn, zero, maxbtn) sehvdirr!!!


//     let fidan = "fidan"
// console.log(fidan)
// localStorage.setItem("fidan", "fidan");


localStorage.setItem("newbasket", JSON.stringify(basket));
console.log(JSON.parse(localStorage.getItem("newbasket")));
  })
